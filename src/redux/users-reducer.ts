...
type ActionsType = ToggleFollowACActionType | SetUsersActionType | SetCurrentPageActionType | SetTotalUsersCount | ToggleIsFetchingActionType | ToggleFollowingProgressActionType
